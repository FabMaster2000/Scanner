...
namespace Scanner
{
    [Activity(Label = "@string/label_aufbau_aktivieren", Theme = "@style/AppTheme")]
    public class aufbau_aktivieren_activity : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.aufbau_aktivieren);
