...
namespace Scanner
{
    [Activity(Label = "@string/label_aufbau_info", Theme = "@style/AppTheme")]
    public class aufbau_info_activity : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.aufbau_info);
