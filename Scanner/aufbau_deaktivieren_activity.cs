...
namespace Scanner
{
    [Activity(Label = "@string/label_aufbau_deaktivieren", Theme = "@style/AppTheme")]
    public class aufbau_deaktivieren_activity : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.aufbau_deaktivieren);
