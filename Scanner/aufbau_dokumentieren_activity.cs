...
namespace Scanner
{
    [Activity(Label = "@string/label_aufbau_dokumentieren", Theme = "@style/AppTheme")]
    public class aufbau_dokumentieren_activity : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.aufbau_dokumentieren);
